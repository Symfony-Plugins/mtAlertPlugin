...
<div id="mt_alert_messages">
  <div id="mt_alert_messages_detail" style="display: none">
    <?php echo link_to_function(__('Hide', array(), 'mt_alert_messages'), "jQuery('#mt_alert_messages_detail').fadeOut(500);", array('id' => 'closer')) ?>
  ...
  <?php if (count($mt_alert_messages) > 0): ?>
    <div id="mt_alert_messages_notification" style="display: none">
      <?php echo link_to_function(__('Hide', array(), 'mt_alert_messages'), "jQuery('#mt_alert_messages_notification').fadeOut(500);", array('id' => 'closer')) ?>
      ...
      <?php echo link_to_function(__('Show', array(), 'mt_alert_messages'),
                      "setTimeout(function() { jQuery('#mt_alert_messages_detail').slideDown(1000); }, 1000);
                       jQuery('#mt_alert_messages_notification').slideUp(500);",
                      array('class' => 'mt_alert_messages_detail_expander', 'id' => 'mt_alert_expander', 'style' => 'display: none')) ?>
    </div>
<?php echo javascript_tag() ?>
setTimeout(function() { jQuery('#mt_alert_messages_notification').slideDown(500); }, 2000);
setTimeout(function() { jQuery('#mt_alert_expander').fadeIn(500); }, 4100);
